                    ...
                    if ID1 in stn_ID.keys():
                        ...
                        for i, ID2 in enumerate(range(len(matrixLine) - 2)):
                            ...
                            if stn_ID[ID1] == stn_ID[ID2] and dictID[ID1] != dictID[ID2]:
                                ...
                                if (dictID[ID1] == 'X' and dictID[ID2] == 'Y') or (dictID[ID1] == 'Y' and dictID[ID2] == 'X'):
                                    self.stationDict[stn_ID[ID1]].sigXY = float(matrixLine[i+2])

                                elif (dictID[ID1] == 'X' and dictID[ID2] == 'Z') or (dictID[ID1] == 'Z' and dictID[ID2] == 'X'):
                                    self.stationDict[stn_ID[ID1]].sigXZ = float(matrixLine[i + 2])

                                elif (dictID[ID1] == 'Y' and dictID[ID2] == 'Z') or (dictID[ID1] == 'Z' and dictID[ID2] == 'Y'):
