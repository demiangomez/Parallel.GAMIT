...
urlpatterns = [
    ...
    path('get-rinex-with-status/<int:station_api_id>', views.GetRinexWithStatus.as_view(), name='get_rinex_with_status'),
    path('rinex/<int:pk>', views.RinexDetail.as_view(), name='rinex_detail'),
    path('rinex/<int:pk>/get-previous-station-info', views.GetPreviousStationInfoFromRinex.as_view(), name='rinex_get_previous_station_info'),
    path('rinex/<int:pk>/get-next-station-info', views.GetNextStationInfoFromRinex.as_view(), name='rinex_get_next_station_info'),
    ...
    path('station/<int:station_api_id>/insert-station-info-by-file', views.InsertStationInfoByFile.as_view(), name='insert_station_info_by_file'),
