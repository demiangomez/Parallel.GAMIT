...
urlpatterns = [
    ...
    path('time-series-config/<int:station_api_id>',
         views.TimeSeriesConfigPull.as_view(), name='time_series_config_pull'),
    path('time-series-config/<int:station_api_id>/delete-jump',
         views.TimeSeriesConfigDeleteJump.as_view(), name='time_series_config_delete_jump'),
    path('time-series-config/<int:station_api_id>/reset-polynomial',
         views.TimeSeriesConfigResetPolynomial.as_view(), name='time_series_config_reset_polynomial'),
    path('time-series-config/<int:station_api_id>/reset-periodic',
         views.TimeSeriesConfigResetPeriodic.as_view(), name='time_series_config_reset_periodic'),
    path('time-series-config/<int:station_api_id>/reset-jumps',
         views.TimeSeriesConfigResetJumps.as_view(), name='time_series_config_reset_jumps'),
    path('time-series-config/<int:station_api_id>/set-polynomial',
         views.TimeSeriesConfigSetPolynomial.as_view(), name='time_series_config_set_polynomial'),
    path('time-series-config/<int:station_api_id>/set-periodic',
         views.TimeSeriesConfigSetPeriodic.as_view(), name='time_series_config_set_periodic'),
    path('time-series-config/<int:station_api_id>/set-jumps',
