...
urlpatterns = [
    ...
    path('remove-earthquakes-affected-stations-cache', views.RemoveEarthquakesAffectedStationsCache.as_view(),
         name='remove_earthquakes_affected_stations_cache'),
    ...
    path('station/<int:station_api_id>/parse-station-info-by-file',
         views.ParseStationInfoByFile.as_view(), name='parse_station_info_by_file'),
    ...
    path('stations/<int:station_api_id>/nearby-stations/<int:distance_km>',
         views.GetNearbyStations.as_view(), name='nearby_stations'),
