# Generated by Django 5.0.4 on 2024-07-23 14:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('antenna_description', models.CharField(
                    blank=True, db_column='AntennaDescription', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('network_code', models.CharField(
                    db_column='NetworkCode', max_length=3)),
                ('station_code', models.CharField(db_column='StationCode')),
                ('f_year', models.DecimalField(blank=True, db_column='FYear',
                 decimal_places=50, max_digits=120, null=True)),
                ('x', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=120, null=True)),
                ('y', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=120, null=True)),
                ('z', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=120, null=True)),
                ('sn', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=120, null=True)),
                ('se', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=120, null=True)),
                ('su', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=120, null=True)),
                ('reference_frame', models.CharField(blank=True,
                 db_column='ReferenceFrame', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station_alias', models.CharField(
                    db_column='StationAlias', max_length=4)),
                ('year', models.DecimalField(db_column='Year',
                 decimal_places=65535, max_digits=65535)),
                ('doy', models.DecimalField(db_column='DOY',
                 decimal_places=65535, max_digits=65535)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station_code', models.CharField(
                    db_column='StationCode', max_length=4)),
                ('try_order', models.DecimalField(
                    decimal_places=65535, max_digits=65535)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('depth', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('mag', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('strike1', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('dip1', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('rake1', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('strike2', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('dip2', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('rake2', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('terms', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('frequencies', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(
                    blank=True, decimal_places=50, max_digits=150, null=True), size=None)),
                ('jump_type', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('relaxation', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(
                    blank=True, decimal_places=50, max_digits=150, null=True), size=None)),
                ('year', models.DecimalField(blank=True, db_column='Year',
                 decimal_places=50, max_digits=150, null=True)),
                ('doy', models.DecimalField(blank=True, db_column='DOY',
                 decimal_places=50, max_digits=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('soln', models.CharField(max_length=10)),
                ('object', models.CharField(max_length=10)),
                ('t_ref', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('jump_type', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('relaxation', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(
                ...
                ('frequencies', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(
                    blank=True, decimal_places=50, max_digits=150, null=True), size=None)),
                ('params', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(
                    blank=True, decimal_places=50, max_digits=150, null=True), size=None)),
                ('sigmas', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(
                    blank=True, decimal_places=50, max_digits=150, null=True), size=None)),
                ('metadata', models.TextField(blank=True, null=True)),
                ('hash', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_date', models.DateTimeField(
                    auto_now_add=True, db_column='EventDate')),
                ('event_type', models.CharField(blank=True,
                 db_column='EventType', max_length=6, null=True)),
                ('network_code', models.CharField(blank=True,
                 db_column='NetworkCode', max_length=3, null=True)),
                ('station_code', models.CharField(blank=True,
                 db_column='StationCode', max_length=4, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height_code', models.CharField(
                    db_column='HeightCode', max_length=5)),
                ('v_offset', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('h_offset', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doy', models.DecimalField(db_column='DOY',
                 decimal_places=65535, max_digits=65535)),
                ('fyear', models.DecimalField(blank=True, db_column='FYear',
                 decimal_places=50, max_digits=150, null=True)),
                ('x', models.DecimalField(blank=True, db_column='X',
                 decimal_places=50, max_digits=150, null=True)),
                ('y', models.DecimalField(blank=True, db_column='Y',
                 decimal_places=50, max_digits=150, null=True)),
                ('z', models.DecimalField(blank=True, db_column='Z',
                 decimal_places=50, max_digits=150, null=True)),
                ('sigmax', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('sigmay', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('sigmaz', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('variance_factor', models.DecimalField(
                    blank=True, db_column='VarianceFactor', decimal_places=50, max_digits=150, null=True)),
                ('sigmaxy', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('sigmayz', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('sigmaxz', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('residual', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_year', models.DecimalField(blank=True, db_column='FYear',
                 decimal_places=50, max_digits=150, null=True)),
                ('wl', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('nl', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('nrms', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('relaxed_constrains', models.TextField(blank=True, null=True)),
                ('max_overconstrained', models.CharField(
                    blank=True, max_length=8, null=True)),
                ('updated_apr', models.TextField(blank=True, null=True)),
                ('iterations', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('node', models.CharField(blank=True, max_length=50, null=True)),
                ('execution_time', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doy', models.DecimalField(db_column='DOY',
                 decimal_places=65535, max_digits=65535)),
                ('centroid', django.contrib.postgres.fields.ArrayField(base_field=models.DecimalField(
                    blank=True, decimal_places=50, max_digits=150, null=True), size=None)),
                ('stations', django.contrib.postgres.fields.ArrayField(
                    base_field=models.CharField(), size=None)),
                ('alias', django.contrib.postgres.fields.ArrayField(
                    base_field=models.CharField(), size=None)),
                ('ties', django.contrib.postgres.fields.ArrayField(
                    base_field=models.CharField(), size=None)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doy', models.DecimalField(db_column='DOY',
                 decimal_places=65535, max_digits=65535)),
                ('ztd', models.DecimalField(db_column='ZTD',
                 decimal_places=65535, max_digits=65535)),
                ('model', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('sigma', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_chars', models.IntegerField(
                    blank=True, db_column='TotalChars', null=True)),
                ('rinex_col_out', models.CharField(blank=True, null=True)),
                ('rinex_col_in', models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('network_code', models.CharField(
                    db_column='NetworkCode', unique=True)),
                ('network_name', models.CharField(
                    blank=True, db_column='NetworkName', null=True)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'networks',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver_description', models.CharField(blank=True,
                 db_column='ReceiverDescription', max_length=22, null=True)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'receivers',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observation_year', models.DecimalField(
                    db_column='ObservationYear', decimal_places=50, max_digits=150)),
                ('observation_month', models.DecimalField(
                    db_column='ObservationMonth', decimal_places=50, max_digits=150)),
                ('observation_day', models.DecimalField(
                    db_column='ObservationDay', decimal_places=50, max_digits=150)),
                ('observation_doy', models.DecimalField(
                    db_column='ObservationDOY', decimal_places=50, max_digits=150)),
                ('observation_f_year', models.DecimalField(
                    db_column='ObservationFYear', decimal_places=50, max_digits=150)),
                ('observation_s_time', models.DateTimeField(
                    blank=True, db_column='ObservationSTime', null=True)),
                ('observation_e_time', models.DateTimeField(
                    blank=True, db_column='ObservationETime', null=True)),
                ('receiver_type', models.CharField(blank=True,
                 db_column='ReceiverType', max_length=20, null=True)),
                ('receiver_serial', models.CharField(blank=True,
                 db_column='ReceiverSerial', max_length=20, null=True)),
                ('receiver_fw', models.CharField(blank=True,
                 db_column='ReceiverFw', max_length=20, null=True)),
                ('antenna_type', models.CharField(blank=True,
                 db_column='AntennaType', max_length=20, null=True)),
                ('antenna_serial', models.CharField(blank=True,
                 db_column='AntennaSerial', max_length=20, null=True)),
                ('antenna_dome', models.CharField(blank=True,
                 db_column='AntennaDome', max_length=20, null=True)),
                ('filename', models.CharField(blank=True,
                 db_column='Filename', max_length=50, null=True)),
                ('interval', models.DecimalField(
                    db_column='Interval', decimal_places=50, max_digits=150)),
                ('antenna_offset', models.DecimalField(
                    blank=True, db_column='AntennaOffset', decimal_places=50, max_digits=150, null=True)),
                ('completion', models.DecimalField(
                    db_column='Completion', decimal_places=3, max_digits=7)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'rinex',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station_code', models.CharField(
                    db_column='StationCode', max_length=4)),
                ('station_alias', models.CharField(
                    db_column='StationAlias', max_length=4, unique=True)),
                ('api_id', models.AutoField(primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver_code', models.CharField(
                    db_column='ReceiverCode', max_length=22)),
                ('receiver_serial', models.CharField(blank=True,
                 db_column='ReceiverSerial', max_length=22, null=True)),
                ('receiver_firmware', models.CharField(blank=True,
                 db_column='ReceiverFirmware', max_length=10, null=True)),
                ('antenna_code', models.CharField(
                    db_column='AntennaCode', max_length=22)),
                ('antenna_serial', models.CharField(blank=True,
                 db_column='AntennaSerial', max_length=20, null=True)),
                ('antenna_height', models.DecimalField(
                    blank=True, db_column='AntennaHeight', decimal_places=4, max_digits=6, null=True)),
                ('antenna_north', models.DecimalField(
                    blank=True, db_column='AntennaNorth', decimal_places=4, max_digits=12, null=True)),
                ('antenna_east', models.DecimalField(
                    blank=True, db_column='AntennaEast', decimal_places=4, max_digits=12, null=True)),
                ('height_code', models.CharField(db_column='HeightCode')),
                ('radome_code', models.CharField(
                    db_column='RadomeCode', max_length=7)),
                ('date_start', models.DateTimeField(db_column='DateStart')),
                ('date_end', models.DateTimeField(
                    blank=True, db_column='DateEnd', null=True)),
                ('receiver_vers', models.CharField(blank=True,
                 db_column='ReceiverVers', max_length=22, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('station_code', models.CharField(
                    db_column='StationCode', max_length=4)),
                ('station_name', models.CharField(blank=True,
                 db_column='StationName', max_length=40, null=True)),
                ('date_start', models.DecimalField(
                    blank=True, db_column='DateStart', decimal_places=3, max_digits=7, null=True)),
                ('date_end', models.DecimalField(
                    blank=True, db_column='DateEnd', decimal_places=3, max_digits=7, null=True)),
                ('auto_x', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('auto_y', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('auto_z', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('harpos_coeff_otl', models.TextField(
                    blank=True, db_column='Harpos_coeff_otl', null=True)),
                ...
                ('height', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
                ('max_dist', models.DecimalField(blank=True,
                 decimal_places=50, max_digits=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('GET', 'GET'), ('POST', 'POST'), ('PUT', 'PUT'), (
                    'DELETE', 'DELETE'), ('PATCH', 'PATCH'), ('ALL', 'ALL')], max_length=6)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_path', models.ImageField(
                    blank=True, upload_to='monument_type_photos/')),
            ],
        ),
        migrations.CreateModel(
            name='Page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('communications_description', models.CharField(
                    blank=True, max_length=100)),
                ('observations_file', models.FileField(
                    blank=True, upload_to='station_observations_files/')),
                ('observations_filename', models.CharField(
                    blank=True, max_length=100)),
                ('navigation_file', models.FileField(
                    blank=True, upload_to='station_navigation_files/')),
                ('navigation_filename', models.CharField(
                    blank=True, max_length=100)),
                ('has_gaps', models.BooleanField(default=False)),
                ('has_gaps_last_update_datetime',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observations_file', models.FileField(
                    blank=True, upload_to='visit_observations_files/')),
                ('observations_filename', models.CharField(
                    blank=True, max_length=100)),
                ('navigation_file', models.FileField(
                    blank=True, upload_to='visit_navigation_files/')),
                ('navigation_filename', models.CharField(
                    blank=True, max_length=100)),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='api.clustertype'),
        ),
        migrations.AddField(
            model_name='endpointscluster',
            name='endpoints',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, to='api.endpointscluster'),
        ),
        migrations.AddField(
            model_name='role',
            name='pages',
        ...
        migrations.AddField(
            ...
            name='station',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='api.stations'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='monument_type',
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.monumenttype'),
        ),
        migrations.AddField(
            model_name='stationmeta',
            name='station',
        ...
        migrations.AddField(
            ...
            name='role',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='api.stationrole'),
        ),
        migrations.AddField(
            model_name='stationmeta',
            name='status',
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.stationstatus'),
        ),
        migrations.AddField(
            model_name='stationmeta',
            name='station_type',
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.stationtype'),
        ),
        migrations.AddField(
            model_name='visits',
            name='campaign',
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.campaigns'),
        ),
        migrations.AddField(
            model_name='visits',
            name='people',
        ...
        migrations.AddField(
            ...
            name='visit',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='api.visits'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=(
                'resource', 'cluster_type', 'description'), name='resource_cluster_type_description_unique'),
        ),
        migrations.AddConstraint(
            model_name='rolepersonstation',
            constraint=models.UniqueConstraint(
