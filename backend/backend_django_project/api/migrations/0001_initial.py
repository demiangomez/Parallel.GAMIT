...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('remote_access_link', models.CharField(blank=True, max_length=100)),
        ...
        migrations.AddField(
            ...
            name='monument_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.monumenttype'),
        ),
        migrations.AddField(
            model_name='stationmeta',
            name='station',
        ...
        migrations.AddField(
            model_name='stationmeta',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.stationstatus'),
        ),
        migrations.AddConstraint(
            model_name='endpointscluster',
        ...
        migrations.AddConstraint(
            model_name='roleuserstation',
            constraint=models.UniqueConstraint(fields=('role', 'user', 'station'), name='role_user_station_unique'),
        ),
    ]
