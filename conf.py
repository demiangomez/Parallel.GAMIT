# -*- coding: utf-8 -*-
#
# Parallel.GAMIT documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('./stacker'))
sys.path.insert(0, os.path.abspath('./com'))
...
copyright = u'2019, Demian D. Gomez'
author = u'Demian D. Gomez'
